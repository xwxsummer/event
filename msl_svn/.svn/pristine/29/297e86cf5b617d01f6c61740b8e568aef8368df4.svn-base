...
//《货主端》根据主单编号分组取消未装车订单及剩余货单
  ...
  //移除银行卡
  public static unBinding =Api.apiHost +Api.walletService +"/bankCard/unBinding";
  //密码重置第一步
  public static walletCheckMobile =Api.apiHost +Api.walletService +"/wallet/checkMobile";
  //查询收支明细
 ...
 //public static tradeList =Api.apiHost +Api.walletService +"/trade";
  ...
  public static getOwnerRemarkByChildNo =  Api.apiHost + Api.orderService + "/order/child/getOwnerRemarkByChildNo";
