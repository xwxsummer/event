...
export class Api{
  ...
  // public static apiHost = "http://192.168.1.230";
  ...
  //网银支付
  public static cpcnDirect = environment.apiHost  + Api.walletService + "/recharage/cpcnDirect"
  //查询绑定的银行卡
  ...
  //开通快捷支付，验证码校验
  public static binding = environment.apiHost + Api.walletService + "/cpcn/binding";
  //移除银行卡
  public static unBinding = environment.apiHost + Api.walletService + "/bankCard/unBinding";
  //查询有绑定快捷支付的银行卡
  public static findFasterList = environment.apiHost + Api.walletService + "/bankCard/findFasterList";
  //快捷支付短信验证确认支付
  public static fasterPay = environment.apiHost + Api.walletService + "/cpcn/fasterPay";
  //确认支付短信验证
  public static fasterPayVerify = environment.apiHost + Api.walletService + "/cpcn/fasterPayVerify";
  //提现
  public static settlement = environment.apiHost + Api.walletService + "/cpcn/settlement";
  //重置密码第一步验证码验证
  public static checkMobilePwd = environment.apiHost + Api.walletService + "/wallet/checkMobile";
  //重置密码第二步银行卡信息验证
  public static checkBankCard =  environment.apiHost + Api.walletService + "/wallet/checkBankCard";
  //重置密码第三步输入密码
  public static resetPwd1 = environment.apiHost + Api.walletService + "/wallet/resetPwd";
  //获取每个省的下拉列表
...
//获取发布货源备注图片
public static getRemarkByOrderNo = environment.apiHost + Api.orderService + "/order/info/getRemarkByOrderNo";
