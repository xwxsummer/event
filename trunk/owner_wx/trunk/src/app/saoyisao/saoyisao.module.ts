...
//import { ConfirmGoods } from './confirmGoods/confirmGoods.component';
@NgModule({
  imports: [
  ...
  exports: [],
  declarations: [
    Saoyisao,RefuseZhuangche,RefuseSuccess,DetailsInfo,RefuseResult,ZhuangCheInfo,ZhuangcheSuccess
  ],
